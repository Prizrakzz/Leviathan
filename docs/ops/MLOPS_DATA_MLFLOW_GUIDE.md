...
| `silver_sagis_cec` | `silver/sagis_cec` | SA crop estimates committee. **Currently degraded**: multi-era scope mislabels pending the CEC parser-repair wave (task #118) — do not train on CEC-derived features until that lands. |

...
-- dataset_id=gold_v2_feature_spine
-- registry_sha256=5051253d025cfdb39d7754504161873adc301225bfb70e9f3064e8e15a7c1d6b
CREATE EXTERNAL TABLE IF NOT EXISTS `leviathan_dev`.`gold_v2_feature_spine` (
    `entity_type`          STRING,
    `entity_id`            STRING,
...
STORED AS PARQUET
LOCATION 's3://leviathan-dev-shahem-001/gold_v2/feature_spine/'
TBLPROPERTIES (
    ...
    'storage.location.template' = 's3://leviathan-dev-shahem-001/gold_v2/feature_spine/dataset_version=${dataset_version}/commodity=${commodity}/'
);

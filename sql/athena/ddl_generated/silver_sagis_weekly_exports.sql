-- silver_sagis_weekly_exports - trade_flows silver table (source); SILVER-F011 registry-generated DDL.
--
-- GENERATED from the SILVER-F010 registry (configs/silver/tables/silver_sagis_weekly_exports.yaml) by
...
CREATE EXTERNAL TABLE IF NOT EXISTS silver_sagis_weekly_exports (
    season          string,
    crop            string,
    week_number     bigint,
    week_ending     string,

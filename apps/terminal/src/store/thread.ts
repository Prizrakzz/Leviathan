 ...
 * context; `openThread` switches to a saved one (its durable turns re-load from the backend).
 */
export interface ThreadState {
  threadId: string;
  title: string | null; // first question of the thread — the switcher label
  newThread: () => void;

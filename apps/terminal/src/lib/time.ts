 ...
 *  renders here), and the dossier allowance resets on a UTC CALENDAR-MONTH boundary (D-DR-2b) -- so the day
 *  shown has to be the UTC day, not the local one, or a desk in Amman reads the reset as a day early. Never
 *  hand-labels a weekday; the date is the fact. */

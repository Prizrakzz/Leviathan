...
def test_the_trace_key_is_registered_at_the_tail_with_its_denominator():
    ...
    assert tk.TRACE_RECORD_KEYS[-26] == "plan_tokens"  # lane F re-pin: +4. NOT `plan_usage`:  # 09-24 K20: +3
    #                                                        # the SIZE of the writer's popped plan
    #                                                        # region, never the planner's tokens

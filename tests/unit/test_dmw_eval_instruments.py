...
def test_wrong_slot_audit_is_a_registered_column_at_the_tail():
    ...
    assert tk.TRACE_RECORD_KEYS[-13] == "wrong_slot_audit"
    assert tk.TRACE_RECORD_KEYS[-12] == "slot_orphan_dropped"
    assert tk.TRACE_RECORD_KEYS[-11] == "episode_spans_validated"
    assert tk.TRACE_RECORD_KEYS[-10] == "plan_tokens"
    assert tk.TRACE_RECORD_KEYS[-9] == "evidence_slot_dropped"
    assert tk.TRACE_RECORD_KEYS[-8] == "evidence_geo_dropped"
    assert tk.TRACE_RECORD_KEYS[-7] == "tables_queried"
    assert tk.TRACE_RECORD_KEYS[-6] == "timing_ms"
    assert tk.TRACE_RECORD_KEYS[-5] == "xc_open_pair"
    assert tk.TRACE_RECORD_KEYS[-4] == "xc_open_decline"
    assert tk.TRACE_RECORD_KEYS[-3] == "xc_regional_decline"
    assert tk.TRACE_RECORD_KEYS[-2] == "quantify_rv_reading_fenced"
    assert tk.TRACE_RECORD_KEYS[-1] == "quantify_derived_fenced"    # D-DA append, 09-01

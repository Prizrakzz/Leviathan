...
def load_feature_policy(path: str | Path | None = None) -> FeaturePolicyRegistry:
    ...
    default = str(raw.get("default_policy", "fundamental_physical"))
...
def apply_feature_policy(
    ...
    *,
    ...
    features fail the run.  Allowed economic drivers are admitted only for
    ...
    for feature in feature_cols:
        ...
        policy = rule.policy if rule else registry.default_policy

...
started 2026-09-10T13:16:29+00:00  wall 200.4 s  boards 36  runs 144  ATHENA_CALLS=0  estate=pg-mirror
physical mirror reads 3484 (p50 2.72 ms, max 151.02 ms); declines {}
...
quick         36    3/ 14.5/ 23       25   35/ 54.0/ 72      3383.5     0
deep          36   15/ 24.0/ 35       45   43/ 85.5/100      5320.0     0
max           36   19/ 30.5/ 39       57   61/109.0/131      6851.5     0

## probes
P0 measured: per-read p50 w1=1.84 ms, w2=2.4 ms, w4=9.38 ms
P1 neither
...
P5 no prior vintage existed: this run BANKS the first snapshot and reports the internal lag witness only -- silver_noaa_iod: 0 lag-column mismatch(es) over 913 checks against ['iod_dmi_3month_avg']; silver_noaa_oni: 0 lag-column mismatch(es) over 3638 checks against ['oni_anom']
destinations 7 series read at the 5,000-row cap and would truncate silently: corn_cbot, hard_red_spring_wheat_mgex, hard_red_winter_wheat_kcbt, soft_red_winter_wheat_cbot, soybean_meal_cbot, soybean_oil_cbot, soybeans_cbot
oni_crossings ONI crossed 32 time(s) over 129 months from 2015-09 (a desk band is declared)
tape the front expiry is named on 23 of 26 tape boards; reasons {'served': 23, 'cash_reference': 2, 'roll_inputs_absent': 1}; 1 read(s) hit the cap
     P1 detail: d2 passes on [], alternative on []; branch: sec 3.2's pre-registered branch: apply the alternative tuple and re-run P1 before S5 -- an OWNER decision on this artifact, not taken here
...
ALTERNATIVE PASS: the alternative tuple selects a different top row on 22 of 36 board/mode pair(s); net reads differ by +0 across the pass
...
- pg_read_latency_ms [measured]: {"1": {"n": 24, "p50": 1.84, "p90": 10.46, "max": 11.57, "mean": 3.38, "total": 81.12}, "2": {"n": 24, "p50": 2.4, "p90": 12.1, "max": 17.07, "mean": 5.06, "total": 121.44}, "4": {"n": 24, "p50": 9.38, "p90": 19.6, "max": 28.44, "mean": 10.79, "total": 258.93}}
    quoted: every latency delta in secs 3.8 and 7 is a projection until P0 (Appendix B)
- pool_contention [measured]: {"state_cache": "off", "state_cache_note": "the memo is OFF: every agent-thread read is a physical read and the load is real", "board_wall_ms": 171.0, "board_per_read": {"n": 24, "p50": 7.74, "p90": 21.53, "max": 33.78, "mean": 10.91, "total": 261.79}, "board_reads": 24, "board_declines": {}, "board_pool_declined_rate": 0.0, "board_statuses": {"ok": 23, "read_empty:all_blank": 1}, "agent_reads": 1
...
- oni_iod_revision_magnitude [measured]: "no prior vintage existed: this run BANKS the first snapshot and reports the internal lag witness only -- silver_noaa_iod: 0 lag-column mismatch(es) over 913 checks against ['iod_dmi_3month_avg']; silver_noaa_oni: 0 lag-column mismatch(es) over 3638 checks against ['oni_anom']"
    quoted: the magnitude of any in-place ONI / IOD revision on the mirror -- no prior vintage exists (Appendix B)
- esr_fgis_destination_counts [measured]: {"series": 11, "read": 11, "min_headroom": -18490, "at_cap": ["corn_cbot", "hard_red_spring_wheat_mgex", "hard_red_winter_wheat_kcbt", "soft_red_winter_wheat_cbot", "soybean_meal_cbot", "soybean_oil_cbot", "soybeans_cbot"], "unread": 0, "verdict": "7 series read at the 5,000-row cap and would truncate silently: corn_cbot, hard_red_spring_wheat_mgex, hard_red_winter_wheat_kcbt, soft_red_winter_whea
    quoted: the per-slug ESR / FGIS destination counts and the 52-week window's headroom under the 5,000-row cap (Appendix B)
- per_anchor_line_counts [measured]: {"quick": {"lines": {"min": 35, "median": 54.0, "max": 72}, "est_tokens": {"min": 2132, "median": 3383.5, "max": 4587}, "planned_lines": "17-20", "planned_tokens": 1100}, "deep": {"lines": {"min": 43, "median": 85.5, "max": 100}, "est_tokens": {"min": 2740, "median": 5320.0, "max": 6090}, "planned_lines": "~40", "planned_tokens": 2400}, "max": {"lines": {"min": 61, "median": 109.0, "max": 131}, "e
...
- p1_falsifier [measured]: {"verdict": "neither", "d2_passes_on": [], "alternative_passes_on": []}
...
- oni_crossing_count [measured]: {"crossings": 32, "history_start": "2015-09", "n_periods": 129, "windows": {"1_2q": {"opens": "2026-07-30", "closes": "2026-10-30", "open_ended": false, "declined": null}, "2_4q": {"opens": "2026-10-30", "closes": "2027-04-30", "open_ended": false, "declined": null}}}

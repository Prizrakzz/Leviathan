...
CURATION_OVERRIDES: dict = {
    ...
    "silver_psd": {
        ...
        "notes_append": (
            ...
            "exactly two months (2006-07 and 2008-10) covering 51,415 of 247,294 rows (20.79%, "
            "split 51,259 / 156 and counted on the day rule each row SHIPPED with, not on its "
            "release month -- 39 further rows in those two months are WM&T sheets that take "
            "month-end anyway); and "
